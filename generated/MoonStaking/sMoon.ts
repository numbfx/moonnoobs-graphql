...
export class sMoon__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sMoon extends ethereum.SmartContract {
  static bind(address: Address): sMoon {
    return new sMoon("sMoon", address);
  }
  ...
  rebases(param0: BigInt): sMoon__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sMoon__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sMoon__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
