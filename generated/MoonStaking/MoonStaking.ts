...
export class MoonStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MoonStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class MoonStaking extends ethereum.SmartContract {
  static bind(address: Address): MoonStaking {
    return new MoonStaking("MoonStaking", address);
  }
  ...
  epoch(): MoonStaking__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new MoonStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<MoonStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
  ...
  sMOON(): Address {
    let result = super.call("sMOON", "sMOON():(address)", []);

    return result[0].toAddress();
  }

  try_sMOON(): ethereum.CallResult<Address> {
    let result = super.tryCall("sMOON", "sMOON():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(param0: Address): MoonStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new MoonStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<MoonStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MoonStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
